...
app.controller('LancamentoProgramadoController', ['$scope', '$filter', 'LancamentoProgramadoService', 'ContaService', 'ModalService', 'DatePickerService', 'LISTAS',
    function ($scope, $filter, LancamentoProgramadoService, ContaService, ModalService, DatePickerService, LISTAS) {
        ...
        var criarLancamentoProgramadosLista = function(data) {
            return _.map(data.lancamentoProgramados, function(lancamentoProgramado) {  
                ...
                return _.pick(lancamentoProgramado, 'idLancamentoProgramado', 'tipo', 'data', 'numeroParcela', 'favorecido', 'valor', 'frequencia');
            })
        };
