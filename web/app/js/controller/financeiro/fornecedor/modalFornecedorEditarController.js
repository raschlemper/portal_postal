...
app.controller('ModalFornecedorEditarController', 
    ['$scope', '$modalInstance', 'fornecedor', 'TipoCategoriaService', 'CepService', 'ModalService', 'LISTAS', 'MESSAGES',
    function ($scope, $modalInstance, fornecedor, TipoCategoriaService, CepService, ModalService, LISTAS, MESSAGES) {
        ...
        var validarForm = function (form) {
            if (form.nomeFantasia.$error.required) {
