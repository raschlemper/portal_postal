...
<html lang="en" ng-app="App">
    ...
    <body> 
        ...
        <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/app/js/controller/financeiro/centroCusto/modalEditarCentroCustoController.js"></script>
