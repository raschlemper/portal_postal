            ...
            <div id="container">
                <div id="conteudo">
                    ...
                    <ul class="ul_formulario">
                        <li <%if (temContrato == 0) {%>class="esconder"<%}%>>
                            <dd id="contrato1">
                                <label>Cód. Administrativo</label>
                                <input type="text" name="codEmpresa" id="codEmpresa" size="25" readonly value="<%= login%>" />
                            </dd>
                            <dd id="contrato2">
                                <label>Senha</label>
                                <input type="password" name="senha" id="senha" size="25" readonly value="<%= senha%>" />                                
                            </dd>
                            <dd id="contrato3">
                        ...
                        <li>
                            <dd>
                                ...
                                <input type="hidden" name="cepOrigem" id="cepOrigem" size="10" maxlength="9" onkeypress="mascara(this, maskCep)" value="<%= cep%>" />
