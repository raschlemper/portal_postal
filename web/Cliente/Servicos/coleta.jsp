            ...
            function verificaHorarioColeta() {
                ...
                if (curDay == dia && curMonth == mes && curYear == ano) {
                    ...
                    if (curHour >= hrsAcesso) {
                        alert("Coletas para o mesmo dia devem ser solicitadas até às " + hrFimAcesso + "hrs!");
                        return false;
                ...
                if (parseInt(hrs) < parseInt(hrsIni) || parseInt(hrs) > parseInt(hrsFim)) {
                    alert("A solicitação de coletas estão disponíveis somente entre " + hrIniColeta + "hrs e " + hrFimColeta + "hrs !");
                    return false;
                }
