...
<table cellpadding="0" cellspacing="0" border="0" id="table2" class="tinytable">
    ...
    <tbody>
        ...
        <tr align='center' style="font-size: 11px;">
            ...
            <%} else {%>
            <td>
                <img id='img<%=numeroRegistro%>' style='cursor:pointer;' src='../../imagensNew/tick_circle.png' onclick="javascript:if(confirm('Você tem certeza que deseja marcar este objeto como não entregue?')){chamaJanelaBaixaAr('<%=numeroRegistro%>');}else{return false;}" />
