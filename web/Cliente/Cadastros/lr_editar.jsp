...
<%
    ...
    if (nomeBD != null) {
        ...
        Destinatario des = ContrlRemetenteLR.consultaRetenteById(idDestinatario, idCliente, nomeBD);
...
<div style="width: 100%; margin: 15px;">
    <div style="width: 95%; text-align: left;">
        ...
        <div id='titulo1'>Editar Endereço de Retorno da L.R.</div>
    </div>
    <img style="margin-bottom: 25px;" width="100%" src="../../imagensNew/linha.jpg"/>

    <form name='form5' action='../../ServEditarEnderecoLR' method='post'>
        <ul style="width: 95%; text-align: left;" class="ul_formulario">
            ...
            <li>
                <div class="buttons">
                    ...
                    <input type='hidden' name='idRemetente' value='<%= idDestinatario%>' />
