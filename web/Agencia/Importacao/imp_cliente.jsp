        ...
        <div id="divPrincipal" align="center">
            <div id="container">
                <div id="conteudo">
                    ...
                    <div id="titulo1">Importar Clientes</div>
                    <form method="post" name="form1" action="../../ServImportacao" enctype="multipart/form-data">
                        <ul class="ul_formulario">
                            <li>
                                <dd style="font-size: 12px;">
                                    &raquo; Você possui <b style="color:red;"><%= num %></b> Clientes.<br/>
                                </dd>
                            </li>
                            <li>
                                <dd>
                                    <label>Escolha o Arquivo de Clientes</label>
                                    <input type="file" name="arquivo" />
                                </dd>
                            </li>
                            <li>
                                <dd style="color:red;">
                                    *Após gerado no SECT é encontrado em "C:/clientes.TXT". Para alterar este caminho, no SECT vá em 'Arquivos>>Exportação>>Destino dos Arquivos'<br/>
                                    *Somente serão importados os Clientes marcados como ativos e usuários do SectWeb no SECT
                                    <div class="buttons">
                                        <button type="button" class="positive" onclick="return validaForm();"><img src="../../imagensNew/download2.png"/> IMPORTAR CLIENTES</button>
                                    </div>
                                </dd>
                            </li>
                        </ul>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" id="table2" class="tinytable">
                        <thead>
                            <tr>
                                ...
                                <th><h3>QTD. de Clientes Excluidos</h3></th>
                            </tr>
                        </thead>
                        <tbody>
                            <%
