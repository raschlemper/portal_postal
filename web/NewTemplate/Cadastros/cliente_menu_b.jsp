<%
    ...
    if (activeTabMenu.equals("0")) {
        ...
        mnServ = "btn-primary";
        nomeBarra = "<i class='fa fa-envelope fa-fw'></i> Outros Serviços";
    }
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                        
        <div id="ow-server-footer">
            <a href="cliente_cadastro_b.jsp?idCliente=<%= idCliTabMenu%>" class="col-xs-4 col-sm-4 col-md-2 col-lg-2 text-center <%= mnCli%> "><i class="fa fa-lg fa-home"></i> <span>Cadastro do Cliente</span></a>
            <a href="cliente_departamentos_b.jsp?idCliente=<%= idCliTabMenu%>" class="col-xs-4 col-sm-4 col-md-2 col-lg-2 text-center <%= mnDepto%> "><i class="fa fa-lg fa-sitemap"></i> <span>Departamentos</span></a>
            <a href="cliente_usuarios_b.jsp?idCliente=<%= idCliTabMenu%>" class="col-xs-4 col-sm-4 col-md-2 col-lg-2 text-center <%= mnUser%> "><i class="fa fa-lg fa-users"></i> <span>Usuários</span></a>
