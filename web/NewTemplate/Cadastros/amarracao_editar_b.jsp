                        ...
                        <form name="form1" action="../../ServEditarAmarracao" method="post">
                            <ul class="list-unstyled">   
                                <li class="list-group-item list-group-heading">
                                    <label>DEFINA O NOME E A SIGLA PARA ESTA AMARRAÇÃO:</label>
                                </li>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="nome"  class="form-control" placeholder="Descrição" value="<%= am.getNomeAmarracao()%>" aria-describedby="basic-addon1">
                                            </div>                                        
                                        </div>                    
                                        <div class="col-xs-6 col-sm-3 col-md-3 col-lg-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="sigla"  class="form-control text-uppercase" placeholder="Sigla" value="<%= am.getSiglaAmarracao()%>" aria-describedby="basic-addon1" maxlength="3">
                                            </div>                                        
                                        </div>                
                                        <div class="col-xs-6 col-sm-3 col-md-3 col-lg-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="cepCTE"  class="form-control" placeholder="Cep do CTE" value="<%= am.getCepCT() %>" aria-describedby="basic-addon1" maxlength="9" onkeypress="mascara(this, maskCep)">
                                            </div>                                        
                                        </div>                    
                                        <div class="col-xs-6 col-sm-3 col-md-3 col-lg-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="nomeCTE"  class="form-control" placeholder="Nome do CTE" value="<%= am.getNomeCT() %>" aria-describedby="basic-addon1" maxlength="20" >
                                            </div>                                        
                                        </div>   
                                    </div>   
                                </li>
                                    ...
                                    <ul class="list-inline"> 
                                        ...
                                        <li>
                                            <ul class="list-unstyled"> 
                                                ...
                                                <li class="list-group-item list-group-item-success">
                                                    <select style="min-width:250px;  ;width: 100%;" name="servico_2" id="servico_2" size="<%=listaServ.size()%>">
                                                        <%
                                                            for (int i = 0; i < listaServ.size(); i++) {
                                                                ServicoECT sv = listaServ.get(i);
                                                                if (lista.contains(sv.getGrupoServico())) {
                            ...
                            <ul class="list-unstyled">   
                                ...
                                <li class="list-group-item">
                                    <div style="width: 400px;">
                                        <table class="table table-striped table-bordered table-hover table-condensed" id="table" name="table">
                                            <thead>
                                                <tr>
                                                    <th colspan="2">CEP Inicial</th>
                                                    <th colspan="2">CEP Final</th>
                                                    <th align="center" width="65">Excluir</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <%
                                                ...
                                                <tr class="faixas">
                                                    <td>De</td>
                                                    <td><input class="form-control" type="input" id="cepIni<%= i + 1%>" name="cepIni<%= i + 1%>" value="<%= cepInicial%>" size="15" maxlength="9" onkeypress="mascara(this, maskCep)"></td>
                                                    <td>até</td>
                                                    <td><input class="form-control" type="input" id="cepFim<%= i + 1%>" name="cepFim<%= i + 1%>" value="<%= cepFinal%>" size="15" maxlength="9" onkeypress="mascara(this, maskCep)"></td>
                                                    <td align="center">
                                                        <button type="button" class="btn btn-danger btn-sm" onclick='delRow(this);'><i class="fa fa-lg fa-trash"></i></button>
                                                    </td>
                                                </tr>
                                                <%}%>
                                            </tbody>
                                ...
                                <li class="list-group-item">
                                    ...
                                    <input type="hidden" name="idAmarracao" id="idAmarracao" value="<%= am.getIdAmarracao() %>" />
