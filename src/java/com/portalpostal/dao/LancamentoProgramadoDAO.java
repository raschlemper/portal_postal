...
public class LancamentoProgramadoDAO extends GenericDAO { 
    ...
    public LancamentoProgramado save(LancamentoProgramado lancamentoProgramado) throws Exception {  
        String sql = "INSERT INTO lancamento_programado (idConta, idPlanoConta, idLancamentoParcelado, tipo, favorecido, "
                   + "numero, idTipoDocumento, idTipoFormaPagamento, frequencia, numeroParcela, dataEmissao, dataVencimento, "
                   + "valor, situacao, historico) "
                   + "VALUES(:idConta, :idPlanoConta, :idLancamentoParcelado, :tipo, :favorecido, :numero, :idTipoDocumento, "
                   + ":idTipoFormaPagamento, :frequencia, :numeroParcela, :dataEmissao, :dataVencimento, "
                   + ":valor, :situacao, :historico)";        
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public LancamentoProgramado update(LancamentoProgramado lancamentoProgramado) throws Exception {
        String sql = "UPDATE lancamento_programado "
                   + "SET idConta = :idConta, idPlanoConta = :idPlanoConta, idLancamentoParcelado = :idLancamentoParcelado, "
                   + "tipo = :tipo, favorecido = :favorecido, numero = :numero, idTipoDocumento = :idTipoDocumento, "
                   + "idTipoFormaPagamento = :idTipoFormaPagamento, frequencia = :frequencia, numeroParcela = :numeroParcela, "
                   + "dataEmissao = :dataEmissao, dataVencimento = :dataVencimento, valor = :valor, situacao = :situacao, "
                   + "historico = :historico "
