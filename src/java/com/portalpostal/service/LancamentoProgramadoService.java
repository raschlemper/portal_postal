...
public class LancamentoProgramadoService {
    ...
    public List<LancamentoProgramado> findByConta(Integer idConta, Date dataInicio, Date dataFim) throws Exception {
        init();
        List<LancamentoProgramado> lancamentoProgramados = lancamentoProgramadoDAO.findByConta(idConta, dataInicio, dataFim);
        for (LancamentoProgramado lancamentoProgramado : lancamentoProgramados) {
            lancamentoProgramado = setParcelas(lancamentoProgramado);
            lancamentoProgramado = setRateios(lancamentoProgramado);
            lancamentoProgramado = setLancamentos(lancamentoProgramado);
...
//        LancamentoProgramado lancamentoProgramadoResult = lancamentoProgramadoDAO.update(ajustaLancamento(lancamentoProgramado));
    ...
    public LancamentoProgramado updateConta(LancamentoProgramado lancamentoProgramado) throws Exception {
        init();
        return lancamentoProgramadoDAO.updateConta(lancamentoProgramado);
    }
