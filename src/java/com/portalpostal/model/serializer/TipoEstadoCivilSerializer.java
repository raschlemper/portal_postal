...
public class TipoEstadoCivilSerializer extends JsonSerializer<TipoEstadoCivil> {

    @Override
    public void serialize(TipoEstadoCivil value, JsonGenerator jg, SerializerProvider sp) 
