...
public class TipoFavorecidoSerializer extends JsonSerializer<TipoFavorecido> {

    @Override
    public void serialize(TipoFavorecido value, JsonGenerator jg, SerializerProvider sp) 
