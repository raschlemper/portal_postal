...
public class TipoLancamentoSerializer extends JsonSerializer<TipoLancamento> {

    @Override
    public void serialize(TipoLancamento value, JsonGenerator jg, SerializerProvider sp) 
