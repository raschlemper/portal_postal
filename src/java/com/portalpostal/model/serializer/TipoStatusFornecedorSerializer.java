...
public class TipoStatusFornecedorSerializer extends JsonSerializer<TipoStatusFornecedor> {

    @Override
    public void serialize(TipoStatusFornecedor value, JsonGenerator jg, SerializerProvider sp) 
