...
public class TipoSeguroVeiculoSerializer extends JsonSerializer<TipoSeguroVeiculo> {

    @Override
    public void serialize(TipoSeguroVeiculo value, JsonGenerator jg, SerializerProvider sp) 
