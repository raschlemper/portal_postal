...
public class TipoSinistroVeiculoSerializer extends JsonSerializer<TipoSinistroVeiculo> {

    @Override
    public void serialize(TipoSinistroVeiculo value, JsonGenerator jg, SerializerProvider sp) 
