...
public class TipoPlanoContaSerializer extends JsonSerializer<TipoPlanoConta> {

    @Override
    public void serialize(TipoPlanoConta value, JsonGenerator jg, SerializerProvider sp) 
