...
public class TipoStatusColaboradorSerializer extends JsonSerializer<TipoStatusColaborador> {

    @Override
    public void serialize(TipoStatusColaborador value, JsonGenerator jg, SerializerProvider sp) 
