...
public class Clientes {
    ...
    public Clientes(String nome, String endereco, String bairro, String cidade, String uf, int cep, String numero, String complemento) {
        this.nome = nome;
    ...
    public void setAr_digital(int ar_digital) {
        this.ar_digital = ar_digital;
    }
