 ...
 * @author RICADINHO
 */
public class ServEditarDestinatario extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServEditarDestinatario</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServEditarDestinatario at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    throws ServletException, IOException {
        ...
        if (expira == null) {
            ...
            try {
                ...
                Controle.contrDestinatario.editar(idDestinatario, idCliente, nome, cpf_cnpj, empresa, cep, endereco, numero, complemento, bairro, cidade, uf, "", "", "", nomeBD);
