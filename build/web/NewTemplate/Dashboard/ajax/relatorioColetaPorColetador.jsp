...
<div class="row" >
    <div class="form-inline col-md-8" style="margin-bottom: 15px;" >
        <button type="button" class="btn btn-sm btn-default form-control" onclick="doit('colXcoletador.xlsx', 'coletaPcol');">
            <i class="fa fa-lg fa-spc fa-file-excel-o"></i>GERAR EXCELL
        </button>
    </div>
</div>
<table  class="table table-striped table-bordered table-hover table-condensed" id="coletaPcol">
