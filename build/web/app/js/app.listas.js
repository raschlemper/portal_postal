...
app.constant('LISTAS', {
    ...
    "periodo": [{'id': 0, 'codigo': 'mesatual', 'descricao': 'Mês Vigente'},
                {'id': 1, 'codigo': 'setedias', 'descricao': 'Últimos 7 Dias'},
                {'id': 2, 'codigo': 'quinzedias', 'descricao': 'Últimos 15 Dias'},
                {'id': 3, 'codigo': 'trintadias', 'descricao': 'Últimos 30 Dias'},
                {'id': 4, 'codigo': 'sessentadias', 'descricao': 'Últimos 60 Dias'},
                {'id': 5, 'codigo': 'noventadias', 'descricao': 'Últimos 90 dias'}],
