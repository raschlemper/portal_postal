...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
            ...
            function getComboA(sel) {
                ...
                $.ajax({
                    ...
                    dataType: "text",
                        ...
                        .done(function (json) {
                            obj = JSON.parse(json);
                            //document.getElementById("demo").innerHTML = obj.login[0].name + " " + obj.login[0].pass;

                            $('#inputEmail').val(obj.login[0].name);
                            $('#inputPassword').val(obj.login[0].pass);
                        })
        ...
        <%
            ...
            String autoriza = request.getParameter("autho");
            System.out.println(autoriza);
            if (autoriza.equals("scc433ccsscc2")) {
                ArrayList<empresas> lsEmp = Controle.contrEmpresa.listaAGF();
                ...
                <div class="card card-container">                    
                    ...
                    <form action="ServLoginMaster" method="post" class="form-signin">
                        ...
                        <select name="agenciaHoito" class="form-control" onchange="getComboA(this);" >
                            <option value="0">ESCOLHA UMA AGF</option>
                            <% for (empresas emp : lsEmp) {%>
                            <option value="<%=emp.getIdEmpresa()%>"><%=emp.getEmpresa()%></option>
                            <% } %>
                        </select>
                        </br>
                        ...
                        <p style="color:red">!!!ACESSO RESTRITO A SCC4!!!</p>
                    </form><!-- /form -->
                    <div id="demo"></div>
                </div><!-- /card-container -->
