<%@page import="Controle.ContrlRemetenteLR"%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function verEditarRemetente(idRemetente, idCliente) {
                http.open("GET", "../../Cliente/Cadastros/lr_editar.jsp?idRemetente=" + idRemetente + "&idCliente=" + idCliente, true);
        ...
        <title>Portal Postal | Cadastro de Retorno LR</title>
        ...
        <div id="divPrincipal" align="center">
            <div id="container">
                <div id="conteudo">
                    ...
                    <div id="titulo1">Cadastro de Endereços de Retorno para Logistica Reversa</div>

                    <form name="form1" action="../../ServInserirEndercoLR" method="post">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" id="table2" class="tinytable">
                        ...
                        <tbody>
                            <%
                                ArrayList<Destinatario> lista = ContrlRemetenteLR.pesquisaLR(cli.getCodigo(), "", "", "", "", "", "", "", "", nomeBD);
                            ...
                            <tr style="cursor:default;">
                                ...
                                <td align="center"><a onclick="verEditarRemetente(<%= des.getIdDestinatario()%>, <%= cli.getCodigo()%>);" style="cursor:pointer;" ><img src="../../imagensNew/pencil.png" /></a></td>
                                <td align="center">
                                    <form action="../../ServExcluirEnderecoLR" method="post" name="formDel">
                                        <input type="hidden" name="idCliente" value="<%= cli.getCodigo()%>" />
                                        <input type="hidden" name="idRemetente" value="<%= des.getIdDestinatario()%>" />
