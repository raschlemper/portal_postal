            ...
            <div id="container">
                <div id="conteudo">
                    ...
                    <ul class="ul_formulario" style="width: 636px; height: 220px; margin-right: 0; border-right: 1px solid silver;">
                        <li class="titulo">
                            <dd><span>MONTE A SUA PESQUISA</span></dd></li>
                        <li>
                            <dd>
                        ...
                        <li>
                            ...
                            <dd>
                                 ...
                                 <input style="width: 125px;" type="text" name="conteudo" id="idConteudo" value="" maxlength="100" /> 
                            </dd>
                             <dd>
                                 <label>Observação</label>
                                 <input style="width: 125px;" type="text" name="observacao" id="idObservacao" value="" maxlength="100" /> 
                            </dd>
                        ...
                        <li>
                            ...
                            <dd>
                                ...
                                <input style="position : relative ; top:3px;" name="atrasado" id="atrasado" value="1" type="checkbox" /><b> SOMENTE COM ATRASO<br/><br/>
                            <%}else{%>
