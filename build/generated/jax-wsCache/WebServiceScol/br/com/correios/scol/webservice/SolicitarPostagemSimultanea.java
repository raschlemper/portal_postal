 ...
 *         &lt;element name="coletas_solicitadas" type="{http://webservice.scol.correios.com.br/}coletaSimultaneaTO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SolicitarPostagemSimultanea {
    ...
    protected List<ColetaSimultaneaTO> coletasSolicitadas;
     ...
     * 
     */
    public List<ColetaSimultaneaTO> getColetasSolicitadas() {
        if (coletasSolicitadas == null) {
            coletasSolicitadas = new ArrayList<ColetaSimultaneaTO>();
        }
