...
app.constant('LISTAS', {
    ...
    "periodo": [{'id': 0, 'codigo': 'vencido', 'descricao': 'Vencido'},
                {'id': 7, 'codigo': 'diaatual', 'descricao': 'Hoje'},
                {'id': 1, 'codigo': 'mesatual', 'descricao': 'Mês Vigente'},
                {'id': 8, 'codigo': 'ultimodiautil', 'descricao': 'Último Dia Útil'},
                {'id': 2, 'codigo': 'ultimosetedias', 'descricao': 'Últimos 7 Dias'},
                {'id': 3, 'codigo': 'ultimoquinzedias', 'descricao': 'Últimos 15 Dias'},
                {'id': 4, 'codigo': 'ultimotrintadias', 'descricao': 'Últimos 30 Dias'},
                {'id': 5, 'codigo': 'ultimosessentadias', 'descricao': 'Últimos 60 Dias'},
                {'id': 6, 'codigo': 'ultimonoventadias', 'descricao': 'Últimos 90 dias'},
                {'id': 9, 'codigo': 'proximodiautil', 'descricao': 'Próximo Dia Útil'},
                {'id': 10, 'codigo': 'proximosetedias', 'descricao': 'Próximos 7 Dias'},
                {'id': 11, 'codigo': 'proximoquinzedias', 'descricao': 'Próximos 15 Dias'},
                {'id': 12, 'codigo': 'proximotrintadias', 'descricao': 'Próximos 30 Dias'},
                {'id': 13, 'codigo': 'proximosessentadias', 'descricao': 'Próximos 60 Dias'},
                {'id': 14, 'codigo': 'proximonoventadias', 'descricao': 'Próximos 90 Dias'}],
