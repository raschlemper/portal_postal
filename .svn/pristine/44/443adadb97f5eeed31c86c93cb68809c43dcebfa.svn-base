                    ...
                    <form name="form1" action="../../ServInserirAmarracao" method="post">
                        <ul class="ul_formulario">                            
                            ...
                            <li>
                                ...
                                <dd>
                                    <label>Sigla</label>
                                    <input type="text" name="sigla" maxlength="3" size="5" />
                                </dd>
                            </li>
                            ...
                            <li id="divServ" style="clear: both;">
                                ...
                                <dd>
                                    ...
                                    <select style="width: 220px;" name="servico_2" id="servico_2" size="6"></select>
                                </dd>
                            </li>
                            ...
                            <li>
                                <dd>
                                    <table style="border:1px solid silver;" id="table" name="table">
                                        ...
                                        <tr class="faixas">
                                            <td>De</td>
                                            <td><input type="input" id="cepIni1" name="cepIni1" size="15" maxlength="9" onKeyPress="mascara(this,maskCep)" /></td>
                                            <td>Até</td>
                                            <td><input type="input" id="cepFim1" name="cepFim1" size="15" maxlength="9" onKeyPress="mascara(this,maskCep)" /></td>
                                            <td align="center"><img src='../../imagensNew/cross_circle.png' style='cursor:pointer;' onclick='delRow(this);' /></td>
                                            <%--<td align="center"><img src="../../imagensNew/lupa.png" style='cursor:pointer;' onclick="conferirFaixaCep(1, 0);" /></td>--%>
                                        </tr>
                                    </table>
                                </dd>
                            </li>                            
