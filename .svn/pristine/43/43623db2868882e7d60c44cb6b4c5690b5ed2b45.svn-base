...
filter.setIdObjeto(Integer.parseInt(request.getParameter("idObjeto")));
CaixaPostalDao caixaPostalDao = new CaixaPostalDao(nomeBD);
    ...
    <body onload="fecharTelaEspera();<%if (!ContrClienteContrato.consultaStatusContrato(idCli, nomeBD)) {%> alert('O Contrato ou Cartão de Postagem estão Suspensos/Vencidos<br/><br/>Por Favor, entre em contato com a sua agência.<br/><br/>As Etiquetas serão geradas sem contrato até a regularização da situação.');<%}%>">
        ...
        <div id="divInteracao2" class="esconder" style="top:10%; left:12%; right:12%; bottom:10%;" align="center">            
            <div style="width: 100%; margin-top: 15px;">
                ...
                <div class="buttons">
                    <b>Quantidade: </b>
                    <input type="text" name="qtdPost" size="2" id="qtdPost" readonly="true" value="1"/>
                    <br/><br/>
        ...
        <%@ include file="../../Includes/menu_cliente_caixa_postal.jsp" %>
        ...
        <div id="divPrincipal" align="center">
            <div id="container">
                <div id="conteudo">
                   ...
                   <div style='float:right;'><a onclick='window.parent.chamaDivProtecao();' href='#' class='botaoClose'>Fechar</a></div>
                    <div id="titulo1">Gerar Nova Etiqueta para Objeto</div>

                    <form name="form1" action="../../ServPreVendaCaixaPostal" method="post" autocomplete="off">
                        <input type="hidden" name="idObjeto" value="<%=filter.getIdObjeto()%>">
                            ...
                            <ul class="ul_formulario" style="width: 1136px;"  >
                                ...
                                <li id="singleDest1">
                                    <dd>
                                        ...
                                        <input type="text" name="nome" id="nome" size="50" maxlength="70" value="<%=objetoInterno.getDestinatario().getNome()%>" autocomplete="off" style="margin-bottom: 5px;" />
                                        <br/><input type="checkbox" name="salvarDestinatario" id="salvarDestinatario" value="1"  /><i> Salvar os dados do destinatário.</i>
                                    </dd>
                                    <dd>
                                        <label>Empresa</label>
                                ...
                                <li id="singleDest2">
                                    <dd>
                                        ...
                                        <input type="text" name="cep" id="cep" size="8" value="<%=objetoInterno.getDestinatario().getCep()%>" maxlength="9" onchange="mascara(this, maskCep);" onkeypress="mascara(this, maskCep);
                                                handleEnter();" onblur="verPesquisarCepDest(this.value);" autocomplete="off" />
                                    </dd>
                                    <dd>
                                        <label>Endereço<b class="obg">*</b></label>
                                        <input type="text" name="endereco" id="endereco" size="55" maxlength="80" value="<%=objetoInterno.getDestinatario().getLogradouro()%>" autocomplete="off" />
                                    </dd>
                                    <dd>
                                        <label>Nº<b class="obg">*</b></label>
                                        <input type="text" name="numero" id="numero" size="7" value="<%=objetoInterno.getDestinatario().getNumero()%>" maxlength="8" onkeypress="mascara(this, maskNumeroRua)" />
                                        <input type="checkbox" name="sn" id="sn" value="S/N" onclick="semNumero();" /> <span style="font-size: 14px;font-weight: bold">S/N</span>
                                    </dd>
                                    <dd>
                                        <label>Complemento</label>
                                        <input type="text" size="20" <%=objetoInterno.getDestinatario().getComplemento()%> name="complemento" id="complemento" maxlength="50" value="" />
                                    </dd>
                                    <dd>
                                        <label>Bairro</label>
                                        <input type="text" name="bairro" id="bairro" maxlength="50" value="<%=objetoInterno.getDestinatario().getBairro()%>" />
                                    </dd>
                                    <dd>
                                        <label>Cidade<b class="obg">*</b></label>
                                        <input type="text" name="cidade" id="cidade" maxlength="50" readonly value="<%=objetoInterno.getDestinatario().getCidade()%>" />
                                    </dd>
                                    <dd id="ddUf">
                                    ...
                                    <dd style="width: 100%;">
                                        <div class="buttons">
                                            ...
                                            <button type="button" id="prepost" class="positive" onclick="validaDados();"><img src="../../imagensNew/tick_circle.png" /> EFETUAR PRÉ-POSTAGEM</button>
                                             <button style="padding:5px;margin-left:50px;" type="button" class="negative" onclick="window.parent.chamaDivProtecao();"><img src="../../imagensNew/cross_circle.png"> CANCELAR</button>
                                        </div>
                                    </dd>
                                </li>
                            </ul>
