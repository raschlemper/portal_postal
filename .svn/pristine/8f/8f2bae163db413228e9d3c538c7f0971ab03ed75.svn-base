    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (expira == null) {
            ...
            try {
                ...
                Controle.contrUsuario.excluir(idUs, nomeBD);

                sessao.setAttribute("msg", "Usuário Excluido com sucesso!");
                //response.sendRedirect("Agencia/Configuracao/usuario_lista.jsp");
                response.sendRedirect(request.getHeader("referer"));

            } catch (Exception ex) {
                int idErro = ContrErroLog.inserir("Portal Postal - ServExcluirUsuario", "Exception", null, ex.toString());
