 ...
 * @author Ricardinho
 */
public class ServInserirGrupoFat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (expira == null) {
            ...
            try {
                ...
                ContrGrupoFaturamento.inserir(nome, sigla, nomeBD);

                sessao.setAttribute("msg", "Grupo de faturamento inserido com sucesso!");
