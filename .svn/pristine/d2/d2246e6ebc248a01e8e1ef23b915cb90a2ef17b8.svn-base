    ...
    <head>
        ...
        <script>
            ...
            function ajaxtable() {
                ...
                $.ajax({
                    method: "GET",
                    url: "ajax/montaRelatoriosVendedores.jsp",
                    data: {'sql': sqlT, 'dataI': dataIni, 'dataF': dataFim, 'idVendedor': idVend
                    },
                    dataType: "json"
                })
                        .done(function (ret) {
        ...
        <jsp:include page="../includes/navBarTop.jsp"></jsp:include>
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div id="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-12">                       
                                <h4 class="page-header"><b class="text-primary"><i class="fa fa-gears"></i> Cadastros</b> > <small>Vendedores > Relatórios</small></h4>
                            </div>
                        </div>
                        <div class="row">
            ...
            <script type="text/javascript">
                ...
                function validaCampos(sel) {
                    ...
                    if (value === "99" || value === "999" || value === "99999") {
