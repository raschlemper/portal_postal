 ...
 * @author Ricardinho
 */
public class ServEditarGrupoFat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (expira == null) {
            ...
            try {
                ...
                int id = Integer.parseInt(request.getParameter("idGrupoFaturamento"));
                
                ContrGrupoFaturamento.alterar(nome, sigla, id, nomeBD);

                sessao.setAttribute("msg", "Grupo de faturamento alterado com sucesso!");
