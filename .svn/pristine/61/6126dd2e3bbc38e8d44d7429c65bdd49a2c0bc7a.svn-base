 ...
 * @author RICARDINHO
 */
public class ServEditarAmarracao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServEditarAmarracao</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServEditarAmarracao at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Controle.ContrAmarracao.alterar(nome, sigla, idAmarracao, cepCT, nomeCT, nomeBD);
        Controle.ContrAmarracaoCep.excluirByIdAmarracao(idAmarracao, nomeBD);
        Controle.ContrAmarracaoServico.excluirByIdAmarracao(idAmarracao, nomeBD);
        ...
        for(int i=1; i<=contador;i++){
            if(request.getParameter("cepIni"+i) != null && request.getParameter("cepFim"+i) != null){
                ...
                if(!Controle.ContrAmarracaoCep.verificaExistenciaFaixaCep(cepInicial, cepFinal, idAmarracao, sqlAmar, nomeBD)){
