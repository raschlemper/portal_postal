                                          ...
                                          if (geocoder) {
                                              ...
                                              function(point) {
                                                  if (!point) {
                                                      ...
                                                      side_bar_html += '<a href="javascript:myclick(<%=i%>);" onmouseover="gmarkers[<%=i%>].setImage(\'../imagensNew/marker_vermelho.png\');" onmouseout="gmarkers[<%=i%>].setImage(\'<%=corMarker%>\');">- <%= nomeCliente%></a><br><br>';
                                                      bounds.extend(point);
                                                      latitude = 0;
                                                      longitude = 0;
