...
import com.portalpostal.report.dto.LancamentoProgramadoReportDTO;
...
@Path("/lancamento/programado")
public class LancamentoProgramadoReportController {
    ...
    private void init() {
        ...
        nameReport = "lancamentoProgramado";
    }
    ...
    public Response pdf(List<LancamentoProgramadoReportDTO> params) {
        try {
            init(); 
