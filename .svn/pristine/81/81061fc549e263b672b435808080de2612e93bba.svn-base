 ...
 * @author RICADINHO
 */
public class ServEditarContato extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServEditarContato</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServEditarContato at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    throws ServletException, IOException {
        ...
        if (expira == null) {
            ...
            try {
                ...
                Controle.contrContato.editar(idContato, contato, email, fone, setor, nomeBD);
                sessao.setAttribute("msg", "Contato Alterado com Sucesso!");
