                                                                                                ...
                                                                                                <%
                                                                                                    ...
                                                                                                    if (listaColetasWeb.size() > 0) {
                                                                                                        for (int s = 0; s < listaColetasWeb.size(); s++) {
                                                                                                            ...
                                                                                                            String tipo = col.getTipoColeta();
                                                                                                            String obs = col.getObs();
                                                                                                            String dataColeta = sdf1.format(col.getDataHoraColeta());
                                                                                                            String horaColeta = hr1.format(col.getDataHoraColeta());
                                                                                                ...
                                                                                                <div class="list-group-item sourceDiv" id="line<%= idColetaW%>">                                                
                                                                                                    <table  style="width: 100%;">
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td width="60">
                                                                                                                <span class= "xedit label label-success pull-left" name="formataHora" id="<%=idColetaW%>" style=" width: 80px; padding-top: 3px; padding-bottom: 3px; text-align: center; font-size: 90%;">
                                                                                                                    <%= horaColeta%>
                                                                                                                </span> 
                                                                                                                <span class="label label-success pull-left" style="width: 80px; padding-top: 3px; padding-bottom: 3px; text-align: center; font-size: 90%;">
                                                                                                                    <span><%= dataColeta%></span><br/>
                                                                ...
                                                                bootbox.dialog({
                                                                    ...
                                                                    buttons: {
                                                                        ...
                                                                        success: {
                                                                            ...
                                                                            callback: function () {
                                                                                loginRestrito(document.formLoginRestrito);
                                                                            }
                                                                        }
                                                                    }
                                                                });
                                                            ...
                                                            jQuery(document).ready(function () {
                                                                ...
                                                                $(document).on('click', '.editable-submit', function () {
                                                                    ...
                                                                    if (x.indexOf(";") > -1) {
                                                                        ...
                                                                        $.ajax({
                                                                            url: "ajax/edit_hora_col.jsp",
                                                                            data: {pk: x, name: 'dataHoraColeta', value: y},
                                                                            type: 'POST'
                                                                        });
                                                                    }
                                                                ...
                                                                $("[name='formataHora']").on('shown', function () {
                                                                    $(this).data('editable').input.$input.keyup(function (event) {
                                                                        var v = maskHora($(this).val());
                                                                        $(this).val(v);
                                                                    });
                                                                });
