...
public class LancamentoService {
    ...
    public Lancamento updateConta(Lancamento lancamento) throws Exception {
        init();
        return lancamentoDAO.updateConta(lancamento);
    }
...
//            rateio.setLancamento(createLancamentoToRateio(lancamento));
    ...
    private void removerLancamentoAnexo(Lancamento lancamento) throws Exception {
        lancamentoAnexoService.deleteByLancamento(lancamento.getIdLancamento());
    }
