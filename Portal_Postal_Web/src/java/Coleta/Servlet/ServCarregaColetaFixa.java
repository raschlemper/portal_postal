            ...
            try {
                ...
                try {
                    ...
                    for (int i = 0; i < listaColetaFixa.size(); i++) {
                        ...
                        int idColeta = Coleta.Controle.contrColeta.inserir(idCliente, idUsuario, idColetador, 0, idTipo, 2, vDataHoraColeta, "", 2, nomeBD);
                    ...
                    int idErro = ContrErroLog.inserir("HOITO - ServCarregaColetaFixa", "SQLException", null, ex.toString());
