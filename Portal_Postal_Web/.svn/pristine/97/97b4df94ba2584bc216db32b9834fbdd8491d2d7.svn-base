        ...
        <div id="divPrincipal" align="center">
            <div id="container">
                <div id="conteudo">
                    ...
                    <div id="titulo1">Usuários do Cliente <span><%= cliInc.getNomeFantasia() %></span></div>
                    ...
                    <form name="form1" action="../../ServCriarLoginPortal" method="post">
                        <ul class="ul_formulario">
                            ...
                            <li>
                                <dd>
                                    <label>Login</label>
                                    <input style='width:150px;' type="text" autocomplete="off" name="login" onkeyup="confereLoginPortal(this.value);" />
                                    <div id="foo"></div>
                                </dd>
                                <dd>
                                    <label>Senha</label>
                                    <input style='width:150px;' type="password" name="senha" />
                                </dd>
                                <dd>
                                    <label>Repita a Senha</label>
                                    <input style='width:150px;' type="password" name="senha2" />
                                </dd>
                                <dd>
                                    <label>Nível</label>
                                    <select name="nivel">
                            ...
                            <li>
                                <dd>
                                    <label>
                                        ACESSOS:<br/>
                                        <a style="color:blue;font-size: 8px;" onclick="selectAllCombo(document.getElementById('acessos'), true);">MARCAR TUDO</a><br/>
                                        <a style="color:red;font-size: 8px;" onclick="selectAllCombo(document.getElementById('acessos'), false);">DESMARCAR TUDO</a><br/>
                                    </label>
                                ...
                                <dd>
                                    <label>
                                        DEPARTAMENTOS:<br/>
                                        <a style="color:blue;font-size: 8px;" onclick="selectAllCombo(document.getElementById('departamentos'), true);">MARCAR TUDO</a><br/>
                                        <a style="color:red;font-size: 8px;" onclick="selectAllCombo(document.getElementById('departamentos'), false);">DESMARCAR TUDO</a><br/>
                                    </label>
                                ...
                                <dd>
                                    <label>
                                        SERVIÇOS:<br/>
                                        <a style="color:blue;font-size: 8px;" onclick="selectAllCombo(document.getElementById('servicos'), true);">MARCAR TUDO</a><br/>
                                        <a style="color:red;font-size: 8px;" onclick="selectAllCombo(document.getElementById('servicos'), false);">DESMARCAR TUDO</a><br/></label>
                    ...
                    <div id="titulo2">Lista de todos os usuários do cliente</div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" id="table2" class="tinytable">
                        <thead>
                            <tr>
                                ...
                                <th><h3>Senha</h3></th>
                                <th><h3>Nivel</h3></th>
                                <th class="nosort" width="60"><h3>Acessar</h3></th>
                        ...
                        <tbody>
                            ...
                            <tr style="cursor:default;">
                                ...
                                <td><%= nomeNivel%></td>                                
                                <td align="center">                                    
                                    <a href="../../ServLoginCliente?agenciaHoito=<%= idEmpresa %>&loginHoito=<%= loginSc %>&senhaHoito=<%= senhaSc %>" target="_blank" style="cursor:pointer;" ><img src="../../imagensNew/door-in.png" /></a>                                    
                                </td>
                                <td align="center">
                                    <%if(nivel < 99){%>
                                    <a onclick="verEditarLoginPortal(<%= id%>, 1);" style="cursor:pointer;" ><img src="../../imagensNew/pencil.png" /></a>
                                    <%}%>
                                </td>
                                <td align="center">
