        ...
        <div id="divPrincipal" align="center">
            <div id="container">
                <div id="conteudo">
                    ...
                    <div id="titulo1">LISTA DE POSTAGEM DIGITAL</div>
                    <ul class="ul_dados">
                        <li>
                            <dd style="color: red;">
                                <b>ATENÇÃO !!!</b><br/><br/>
                                Esta lista deve ser entregue ao motorista da agência!<br/>
                            </dd>
                        </li>
                    </ul>
                    <img width="100%" src="../../imagensNew/linha.jpg"/>
                    <center>
                        <iframe src="<%=request.getContextPath()%>/ServListaPostagem?idOs=<%= idOs %>&ids=<%= ids %>&qtd=<%= qtd %>" style="overflow: auto;" frameborder="0" scrolling="no" width="45%" height="720"></iframe>
                    </center> 
                </div>
            </div>
        </div>
