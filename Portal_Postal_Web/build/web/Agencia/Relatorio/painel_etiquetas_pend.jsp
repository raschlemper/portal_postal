    ...
    <head>
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            function excluirVenda(idVenda) {
                if (confirm('Tem certeza que deseja inutilizar esta etiqueta?')) {
            ...
            <div id="container">
                <div id="conteudo">
                    ...
                    <div style="width: 100%; padding: 10px; background: white;">
                        ...
                        <form action="painel_etiquetas_pend.jsp" method="post">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" id="table3" class="tinytable">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="120"><h3>Metodo Inserção</h3></th>
                                ...
                                <tbody>
                                    ...
                                    <tr style="cursor:default;">
                                        ...
                                        <td align="center"><a onclick="verVenda2(<%= des.getId()%>, <%= des.getIdCliente()%>);" style="cursor:pointer;" ><img src="../../imagensNew/lupa.png" /></a></td>
                                            <%--<td align="center">
                                                <img style="cursor: pointer;" src="../../imagensNew/cancel.png" border="0" onClick="excluirVenda(<%= des.getId()%>);" />
                                            </td>--%>
                                    </tr>
                                    <%}%>
                                </tbody>
                        ...
                        <script type="text/javascript">
                            ...
                            <div class="buttons">
                                <button type="submit" onclick="abrirTelaEspera();" class="negative"><img src="../../imagensNew/cancel.png"/> INUTILIZAR ETIQUETAS SELECIONADAS</button>
                            </div>                            
                        </form>
                    </div>
