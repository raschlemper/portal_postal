...
<%
            ...
            if (nomeBD != null) {
                ...
                resultado = "<b style='color:red' id='x'>Login Inválido!</b>";
                Connection conn = Util.Conexao.conectar(nomeBD);
                String sql = "SELECT login FROM cliente_usuarios WHERE login = '" + login + "';";
