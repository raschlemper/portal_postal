...
<%
    ...
    if (nomeBD == null) {
        ...
        ArrayList listaColetas = contrColeta.consultaColetasPeloStatus(situacao, idCol, dataPesquisaBD, "dataHoraSolicitacao", nomeBD);
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    ...
    <body>
        <div id="divInteracao" class="esconder" style="top:25%; left:30%; right:30%; bottom:25%;" align="center"></div>
            ...
            <div id="container">
                <div id="conteudo">
                    ...
                    <div style="float:left;width:250px;">
                            ...
                            <li>
                                <dd style="text-align: left;">
                                    <div class="buttons">
                                        ...
                                        <button onclick="javascript:window.location='novaColeta.jsp'" style="width: 205px; text-align: left;" type="button" id="verMapa" class="positive" ><img src="../../imagensNew/truck_plus.png" /> SOLICITAR COLETA</button>
                                        <button onclick="javascript:window.location='consultaSolicitadas.jsp'" style="width: 205px; text-align: left;" type="button" class="regular" ><img src="../../imagensNew/web.png" /> SOLICITAÇÕES WEB <b style="color:red;">(<%= qtdSolicitadas%>)</b></button>
                                    </div>
                                </dd>
                            </li>
                        </ul>
                        ...
                        <img width="240" src="../../imagensNew/linha.jpg"/>
                    </div>
                    ...
                    <div style="width: 900px; margin-left: 260px;">
                        <div id="titulo2" style="clear: none;font-size: 20px; margin-bottom: 0;" >
                            <b style="color:yellow;"><%= nomeColPesquisa%></b> - <%= nomeSituacao %> do dia <b style="color: yellow;"><%= dataPesquisa%></b>
                        </div>
                        <div id="titulo2" style="clear:none;padding:8px 5px; border-top: 0px; border-bottom: 0px; font-size: 12px;">
                            <a style="color: white;background: #2d89ef; padding: 5px;" target="_blank" href="imprimirRota.jsp?idColetador=<%= idCol%>&dataPesquisa=<%= dataPesquisa%>"><img class="link_img" src="../../imagensNew/printer.png" /> IMPRIMIR ROTA</a>&nbsp;
                            <a style="color: white;background: #2d89ef; padding: 5px;" target="_blank" href="gerarMapaRota.jsp?idColetador=<%= idCol%>&dataPesquisa=<%= dataPesquisa%>"><img class="link_img" src="../../imagensNew/map_pin.png" /> GERAR MAPA</a>
                        </div>
                        <form name="formColetas" action="#" method="post">
                            ...
                            <table style="width: 100%;" class="tb1" cellspacing="0">
                                <tr>
                                    ...
                                    <th width="20">TS</th>
                                    <th width="60"><b>HR Prev.</b></th>
                                    <%if(situacao == 0){%><th width="60"><b>HR Baixa</b></th><%}%>
                                ...
                                <tr class="<%=trClass%>">
                                    ...
                                    <td>
                                        <a style="color:<%= cor%>;" onclick="mostrarEndereco(<%= idCli%>, <%= idColeta%>);">
                                    ...
                                    <td><%= tipo%></td>
                                    <td>
                                        <img class="link_img" style="cursor: pointer;" onclick="verEditarObsColeta(<%= idColeta%>, <%= idCol%>);" src="../../imagensNew/note_pencil.png" />
                                        &raquo; <%= obs%>
                                    </td>
                            ...
                            <ul style="width: 900px; padding: 10px 0;" class="ul_formulario">
                                <li>
                                    <dd style="width: 49%;">
                                        ...
                                        <div class="buttons">
                                            <button class="positive" type="submit" onclick="submitForm('../../ServAlterarColetadorColeta');"><img src="../../imagensNew/users.png"/> ALTERAR COLETADOR</button>
                                        </div>
                                        <%}%>
                                    </dd>
                                    <dd style="width: 49%; text-align: right;">
                                        <label>Alterar Status da Coleta</label>
                                        ...
                                        <div class="buttons">
                                            <button style="margin-right: 0;" class="positive" type="button" onClick="submitForm('../../ServAlterarStatusColeta');"><img src="../../imagensNew/refresh.png"/> ALTERAR STATUS</button>
                                        </div>
                                    </dd>
                                </li>
                            </ul>
